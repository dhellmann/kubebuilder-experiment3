...
func (in *ExampleStruct) DeepCopyInto(out *ExampleStruct) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExampleStruct.
func (in *ExampleStruct) DeepCopy() *ExampleStruct {
	if in == nil {
		return nil
	}
...
func (in *SimpleSpec) DeepCopyInto(out *SimpleSpec) {
	*out = *in
	if in.SubStruct != nil {
		in, out := &in.SubStruct, &out.SubStruct
		*out = new(ExampleStruct)
		**out = **in
	}
}
